...
# SECRET_KEY = 'django-insecure-g_oa^hcl@ef5+e4ly90lf$owa*yj-8ah-1!nw$1frch0kv$6qa'
...
ALLOWED_HOSTS = [
    "https://zn-local-library.herokuapp.com/",
    "127.0.0.1",
    "localhost",
]
...
# for function-based views with login_required decorator
